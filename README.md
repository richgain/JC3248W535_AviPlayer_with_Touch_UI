...
The JC3248W535 is a great little ESP32 powered board that incudes a touch screen, audio, SD card slot and battery management. Here I describe how I managed to create an AviPlayer with a touch screen UI using the new JC3248W535-Driver and ArduinoGFX.
